...
#============================================================
#  $Id: weekly.sh,v 5.6 2002/05/08 04:17:41 scott Exp $
...
#============================================================
#  $Log: weekly.sh,v $
#  Revision 5.6  2002/05/08 04:17:41  scott
#  Updated to add works order delete
#
#  Revision 5.3  2002/05/08 04:16:02  scott
#  Updated to add pc_rt_del
#
#  Revision 5.2  2001/11/29 01:03:09  scott
...
run_purge ()
{
	...
	case $SCRIPT in
        *)      
			...
			#-----------------------------------------------
			#| Delete completed works orders transactions. |
			#-----------------------------------------------
			pc_rt_del   2>/dev/null
