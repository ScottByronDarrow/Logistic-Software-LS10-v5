...
|=====================================================================|
| $Id: ol_ctr_inv.c,v 5.0 2002/05/08 01:30:45 scott Exp $
|  Program Name  : (ol_ctr_inv.c)              
|  Program Desc  : (ON LINE Counter packing slip print. 
|---------------------------------------------------------------------
|  Date Written  : (MM/DD/YYYY     | Author      :                    
|---------------------------------------------------------------------
| $Log: ol_ctr_inv.c,v $
| Revision 5.0  2002/05/08 01:30:45  scott
| CVS administration
|
| Revision 1.4  2001/08/09 09:14:16  scott
| Updated to add FinishProgram () function
|
| Revision 1.3  2001/08/07 04:46:35  scott
| RELEASE 5.0
|
|
=====================================================================*/
#define	CCMAIN
char	*PNAME = "$RCSfile: ol_ctr_inv.c,v $",
		*PROG_VERSION = "@(#) - $Header: /usr/LS10/REPOSITORY/LS10.5/OL/ol_ctr_inv/ol_ctr_inv.c,v 5.0 2002/05/08 01:30:45 scott Exp $";
	...
	long	hhcoHash)
{
	...
	*/
	...
	if (miscTotal != 0)
	{
		...
		MiscChargeEntry (ML("Packaging and handing"), cohr_rec.freight);
